...
mi_decl_nodiscard mi_decl_internal bool _mi_os_commit(void* p, size_t size, bool* is_zero);
mi_decl_nodiscard mi_decl_internal bool _mi_os_commit_ex(void* addr, size_t size, bool* is_zero, size_t stat_size);
...
mi_decl_internal mi_decl_noreturn mi_decl_cold void _mi_assert_fail(const char* assertion, const char* fname, unsigned int line, const char* func) mi_attr_noexcept;
